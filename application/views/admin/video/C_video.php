<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Form Input Video</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
<div class="row">
                            ...
                            <div class="panel-heading">
                               Form Data Video
                                    <span style="float:right;">
                                        <?php echo anchor('Admin/Data_video/','<button>Kembali</button>');?>
                                    </span>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                          <?php echo $this->session->set_flashdata('message');?>
                                            <?php
                                                ...
                                                echo form_open_multipart("Admin/Data_video/add",$attributes);
                                            ?>
                                        <form role="form">
